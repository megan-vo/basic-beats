...
var buildExpression = exports.buildExpression = function buildExpression(acc, expr, key, context, isEventHandler) {
  return '\n    ((context) => {\n        var __idyllStateProxy = new Proxy({}, {\n          get: (_, prop) => {\n            return context[prop];\n          },\n          set: (_, prop, value) => {\n            var newState = {};\n            newState[prop] = value;\n            context.update(newState);\n            return true;\n          }\n        })\n        ' + falafel(isEventHandler ? expr : 'var __idyllReturnValue = ' + (expr || 'undefined'), function (node) {
    switch (node.type) {
      case 'Identifier':
...
var evalExpression = exports.evalExpression = function evalExpression(acc, expr, key, context) {
  ...
  var e = buildExpression(acc, expr, key, context, isEventHandler);
